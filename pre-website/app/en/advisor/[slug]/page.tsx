...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const url = `https://www.trustolino.de/en/advisor/${slug}`;
  ...
  return {
    ...
    openGraph: {
      ...
      section: article.meta.category === 'paedagogen' ? 'Educators' : 'Parents',
      images: [
        {
...
export default async function AdvisorArticleEN({ params }: Props) {
  ...
  const jsonLd = {
    ...
    '@graph': [
      {
        '@type': 'Article',
        '@id': `https://www.trustolino.de/en/advisor/${slug}#article`,
        isPartOf: {
          '@type': 'WebPage',
          '@id': `https://www.trustolino.de/en/advisor/${slug}`,
          url: `https://www.trustolino.de/en/advisor/${slug}`,
        ...
        mainEntityOfPage: `https://www.trustolino.de/en/advisor/${slug}`,
        author: {
          '@type': 'Organization',
        ...
        spatialCoverage: {
          '@type': 'Place',
          name: 'Mannheim and Heidelberg, Baden-Württemberg',
          geo: {
            '@type': 'GeoCoordinates',
            latitude: 49.4875,
            longitude: 8.4660,
      ...
      {
        '@type': 'BreadcrumbList',
        '@id': `https://www.trustolino.de/en/advisor/${slug}#breadcrumb`,
        itemListElement: [
          {
            '@type': 'ListItem',
            position: 1,
          ...
          },
          {
            ...
            position: 3,
            name: article.meta.title,
            item: `https://www.trustolino.de/en/advisor/${slug}`,
          },
        ],
      },
    ],
